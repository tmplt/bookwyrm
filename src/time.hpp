...
namespace bookwyrm::time {
    ...
    public:
        ...
        inline void reset() { last_update = clock::now(); }
    ...
    /*
     * A time duration based on seconds, with an interface alike Boost's posix time
     * library. Takes a duration of seconds and divides that up in hours, minutes
     * and seconds.
     */
    class duration {
    public:
